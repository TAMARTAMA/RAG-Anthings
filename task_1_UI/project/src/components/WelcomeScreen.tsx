        ...
        <div className="relative">
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl p-12 border border-blue-100">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              חוויית צ'אט חכמה ומתקדמת<br />
              שאל כל שאלה וקבל תשובות מדויקות ומקצועיות
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              <div className="flex flex-col items-center p-4 rounded-xl bg-blue-50 border border-blue-100 hover:shadow-lg transition-all duration-300">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">שיחות חכמות</h3>
                <p className="text-sm text-gray-600 text-center">צ'אט מתקדם עם זכרון מלא</p>
              </div>
              
              <div className="flex flex-col items-center p-4 rounded-xl bg-blue-50 border border-blue-100 hover:shadow-lg transition-all duration-300">
                <Bot className="w-8 h-8 text-blue-600 mb-3" />
                <h3 className="font-semibold text-gray-900 mb-2">בינה מלאכותית</h3>
                <p className="text-sm text-gray-600 text-center">תשובות מתקדמות ומדויקות</p>
              </div>
              
              <div className="flex flex-col items-center p-4 rounded-xl bg-blue-50 border border-blue-100 hover:shadow-lg transition-all duration-300">
                <Sparkles className="w-8 h-8 text-blue-600 mb-3" />
                <h3 className="font-semibold text-gray-900 mb-2">חוויה מושלמת</h3>
                <p className="text-sm text-gray-600 text-center">ממשק נוח וידידותי למשתמש</p>
              </div>
            </div>
