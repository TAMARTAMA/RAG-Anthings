      ...
      <div className="flex-1 flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-500">
            צור שיחה חדשה כדי להתחיל לשוחח עם BOT&lt;NET
          </p>
        </div>
      </div>
    );
    ...
    <div className="flex-1 flex flex-col bg-white">
      ...
      <div className="border-b border-gray-200 p-4 bg-white">
        ...
        <p className="text-sm text-gray-500 text-right">
          {activeChat.messages.length} הודעות
        </p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {activeChat.messages.length === 0 ? (
          <div className="flex items-center justify-center h-full text-gray-500">
            <div className="text-center">
              <p className="text-lg mb-2">התחל שיחה חדשה</p>
              <p className="text-sm">שאל כל שאלה שמעניינת אותך</p>
            </div>
          </div>
        ) : (
              ...
              <div className="flex gap-4 p-4">
                ...
                <div className="flex-1 max-w-3xl">
                  <div className="bg-gray-100 rounded-2xl p-4">
                    <p className="text-sm text-gray-600">BOT&lt;NET כותב...</p>
                  </div>
                </div>
              </div>
            )}
      ...
      <div className="border-t border-gray-200 p-4 bg-white">
        <form onSubmit={handleSubmit} className="flex gap-3">
          ...
          <textarea
            ...
            placeholder="שאל את BOT<NET כל שאלה..."
