...
def process_asking(question: str ,system_prompt_keywords_=system_prompt_keywords):
    keywords = send_data_to_server_LLM(SERVER_MODEL_URL, question, system_prompt_keywords_)
